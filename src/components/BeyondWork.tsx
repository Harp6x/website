...
export default function BeyondWork({ sections: sectionsProp }: Props) {
  ...
  return (
    <section id="beyond" className="section-padding px-6 md:px-10">
      <div className="relative z-10 max-w-5xl mx-auto">
        <AnimatedSection>
          ...
          <p className="text-[var(--text-secondary)] text-base max-w-2xl mb-4 leading-relaxed">
          ...
          <p className="text-[var(--text-muted)] text-base max-w-2xl mb-20 leading-relaxed">
